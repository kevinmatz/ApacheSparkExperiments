# "Producer" program to read test data (JSON lines) from a file and publish them
# to a Kafka topic "app-user-events"
#
# See readme.md for instructions on how to generate test data and run this program
# and the Spark pipeline.
#
