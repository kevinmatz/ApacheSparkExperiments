...
# To create a SparkSession with the necessary configuration to use the BareLocalFileSystem
# use this pattern:
#   .config(
...
# Use Kafka connector and also keep Hadoop workaround:
spark = (
    ...
    .config(
        "spark.jars.packages",
        "org.apache.spark:spark-sql-kafka-0-10_2.13:4.1.1"  # Make sure this matches the PySpark version installed -- currently 4.1.1
    )
    .getOrCreate()
)

    # Trying uncommenting this for running under WSL2
    # .config(
    #     "spark.hadoop.fs.file.impl",
    #     "com.globalmentor.apache.hadoop.fs.BareLocalFileSystem"
    # )
